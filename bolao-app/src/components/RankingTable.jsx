              ...
              <div className="min-w-0 flex-1">
                ...
                <div className="mt-2 grid grid-cols-3 gap-2 text-center">
                  <div className="rounded-2xl bg-slate-50 px-2 py-2">
                    <div className="text-[10px] font-bold uppercase tracking-[0.16em] text-slate-500">1a Fase</div>
                    <div className="mt-1 text-sm font-black text-slate-900">{user.ptsJogos}</div>
                  </div>
                  <div className="rounded-2xl bg-slate-50 px-2 py-2">
                    <div className="text-[10px] font-bold uppercase tracking-[0.16em] text-slate-500">Mata-Mata</div>
